...
parser.add_argument('--e_layers', type=int, default=1, help='num of patchTST layers')
...
# forecasting task
parser.add_argument('--context_len', type=int, default=336, help='input sequence length for local_model')
...
# PatchTST
parser.add_argument('--fc_dropout', type=float, default=0.4, help='fully connected dropout')
